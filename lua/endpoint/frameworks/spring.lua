...
function M.get_search_cmd(method)
  local patterns = {
    ...
    ALL = { 
      ...
      "@RequestMapping.*method.*=.*PUT", "@RequestMapping.*method.*=.*DELETE", 
      "@RequestMapping.*method.*=.*PATCH", "@RequestMapping" 
    },
  }
...
function M.extract_method(content, search_method)
  ...
  if annotation then
    if annotation == "Get" then return "GET"
    elseif annotation == "Post" then return "POST"
    elseif annotation == "Put" then return "PUT"
    elseif annotation == "Delete" then return "DELETE"
    elseif annotation == "Patch" then return "PATCH"
    end
  end
